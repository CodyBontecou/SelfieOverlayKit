...
public struct EditorProject: Codable, Equatable {
    ...
    public static let exportSentinelFilename = ".export-in-progress"
    ...
    public var exportSentinelURL: URL { folderURL.appendingPathComponent(Self.exportSentinelFilename) }
